...
export function Environment(name: string): BaseURL {
    return `https://${name}-online-repopack-gdvi.encr.app`
}
...
/**
 * Client is an API client for the online-repopack-gdvi Encore application.
 */
export default class Client {
    public readonly admin: admin.ServiceClient
    public readonly auth: auth.ServiceClient
    public readonly repopack: repopack.ServiceClient
    ...
    constructor(target: BaseURL, options?: ClientOptions) {
        ...
        this.repopack = new repopack.ServiceClient(base)
    }
}
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "online-repopack-gdvi-Generated-TS-Client (Encore/v1.45.2)";
        }
